...
import com.nxm.muzi102.utils.AndroidRomUtil;

/**
 * *******************************************************************************************
 * 修改日期                         修改人             任务名称                 功能或Bug描述
 * 2018年1月4日22:07:10            lzx               权限工具                  用户权限获取页面，权限处理
 * *******************************************************************************************
 */
...
public class PermissionActivity extends Activity {
    ...
    private static final String EXTRA_PERMISSION = "com.jlkf.ego";//权限参数
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkPermission = new CheckPermission(this, PermissionActivity.this);
    ...
    protected void onResume() {
        ...
        if (isrequestCheck) {
            ...
            if (checkPermission.permissionSet(permission)) {
                ...
                Log.e("nxm17117", "去请求权限");
            } else {
                allPermissionGranted();//获取全部权限
                Log.e("nxm17117", "获取全部权限");
            }
        } else {
            isrequestCheck = true;
        }
    ...
    private void startAppSettings() {
        AndroidRomUtil.showDialogToSystemSetting(PermissionActivity.this);

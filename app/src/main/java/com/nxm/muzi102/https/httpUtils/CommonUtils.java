...
//        }
     ...
     * @return 1男，2女  0 未知
     */
    public static int ForCardGetSex(String cardNumber) {

        if (TextUtils.isEmpty(cardNumber)) {
            return 0;
        }
        if (cardNumber.length() == 15 && Integer.parseInt(cardNumber.substring(14)) % 2 == 0) {
            return 2;
        }
        if (cardNumber.length() == 18 && Integer.parseInt(cardNumber.substring(16, 17)) % 2 == 0) {
            return 2;
        }
        return 1;
    }
